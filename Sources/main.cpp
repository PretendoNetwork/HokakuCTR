...
namespace CTRPluginFramework
{
    ...
    void    PatchProcess(FwkSettings &settings)
    {
        ...
        pm.Add(sendRMCV0Pat, sizeof(sendRMCV0Pat), installSendRMC);
        const u8 sendRMCV1Pat1[] = {0x60, 0x40, 0xA0, 0x13, 0x02, 0x00, 0x17, 0xE3, 0x01, 0x4C, 0x84, 0x13, 0x10, 0x00, 0x17, 0xE3};
        pm.Add(sendRMCV1Pat1, sizeof(sendRMCV1Pat1), installSendRMC);
        const u8 sendRMCV1Pat2[] = {0x60, 0x40, 0xA0, 0x13, 0x02, 0x00, 0x18, 0xE3, 0x01, 0x4C, 0x84, 0x13, 0x10, 0x00, 0x18, 0xE3};
        pm.Add(sendRMCV1Pat2, sizeof(sendRMCV1Pat2), installSendRMC);

        const u8 recvRMCV0Pat[] = {0x00, 0x00, 0x50, 0xE3, 0x08, 0x10, 0x90, 0x15, 0x58, 0x00, 0x81, 0xE2, 0xFF, 0x10, 0xCC, 0xE3};
        pm.Add(recvRMCV0Pat, sizeof(recvRMCV0Pat), installRecvRMC);
        const u8 recvRMCV1Pat1[] = {0x0C, 0x50, 0x90, 0x15, 0x58, 0x00, 0x85, 0xE2, 0xFF, 0x10, 0xC6, 0xE3, 0x00, 0x50, 0xA0, 0xE1};
        pm.Add(recvRMCV1Pat1, sizeof(recvRMCV1Pat1), installRecvRMC);
        const u8 recvRMCV1Pat2[] = {0xBC, 0x03, 0xD2, 0xE1, 0x01, 0x70, 0xA0, 0xE1, 0x00, 0x50, 0xA0, 0xE3, 0x02, 0x0B, 0x10, 0xE3};
        pm.Add(recvRMCV1Pat2, sizeof(recvRMCV1Pat2), installRecvRMC);
        const u8 recvRMCV1Pat3[] = {0x02, 0x0B, 0x12, 0xE3, 0x01, 0x70, 0xA0, 0xE3, 0xD0, 0x20, 0xD1, 0xE1, 0x14, 0x00, 0x90, 0xE5};
        pm.Add(recvRMCV1Pat3, sizeof(recvRMCV1Pat3), installRecvRMC);
